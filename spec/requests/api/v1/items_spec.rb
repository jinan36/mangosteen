...
RSpec.describe "Items", type: :request do
  describe "获取账目" do
    ...
    it "分页" do
      user1 = User.create email: "1@qq.com"
      tag1 = Tag.create name: "tag", sign: "x", user_id: user1.id
      user2 = User.create email: "2@qq.com"
      tag2 = Tag.create name: "tag", sign: "x", user_id: user2.id
      11.times { Item.create amount: 100, tags_id: [tag1.id], happen_at: Time.now, user_id: user1.id }
      11.times { Item.create amount: 100, tags_id: [tag2.id], happen_at: Time.now, user_id: user2.id }
    ...
    it "按时间筛选" do
      ...
      item1 = Item.create amount: 100, tags_id: [tag.id], happen_at: Time.now, created_at: "2018-01-01", user_id: user.id
      item2 = Item.create amount: 100, tags_id: [tag.id], happen_at: Time.now, created_at: "2018-01-02", user_id: user.id
      item3 = Item.create amount: 100, tags_id: [tag.id], happen_at: Time.now, created_at: "2018-01-03", user_id: user.id
      Item.create amount: 100, tags_id: [tag.id], happen_at: Time.now, created_at: "2019-01-01", user_id: user.id
      ...
      expect(json["resources"][2]["id"]).to eq item3.id
    end
    it "按时间筛选（只传起始时间）" do
      user = User.create email: "1@qq.com"
      tag = Tag.create name: "tag", sign: "x", user_id: user.id

      Item.create amount: 100, tags_id: [tag.id], happen_at: Time.now, created_at: "2017-12-31", user_id: user.id
      item1 = Item.create amount: 100, tags_id: [tag.id], happen_at: Time.now, created_at: "2018-01-01", user_id: user.id
      item2 = Item.create amount: 100, tags_id: [tag.id], happen_at: Time.now, created_at: "2019-01-01", user_id: user.id
    ...
    it "按时间筛选（只传结束时间）" do
      ...
      item1 = Item.create amount: 100, tags_id: [tag.id], happen_at: Time.now, created_at: "2018-01-01", user_id: user.id
      item2 = Item.create amount: 100, tags_id: [tag.id], happen_at: Time.now, created_at: "2019-01-01", user_id: user.id
      Item.create amount: 100, tags_id: [tag.id], happen_at: Time.now, created_at: "2019-01-02", user_id: user.id
  ...
  describe "创建账目" do
    ...
    it "创建" do
      ...
      expect {
        post("/api/v1/items", params: {amount: 100, tags_id: [tag1.id, tag2.id], happen_at: "2018-01-01T00:00:00+08:00"}, headers: user.generate_auth_header)
